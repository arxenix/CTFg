...
Router.route('/programming', {
    subscriptions: function() {
        return [Meteor.subscribe('unlockedProblems'), Meteor.subscribe('programmingSubmissions')];
    },
    action: function() {
        if (this.ready())
            this.render();
...
Router.route('/problems', {
    subscriptions: function() {
        return [Meteor.subscribe('allProblems'), Meteor.subscribe('unlockedProblems'), Meteor.subscribe('programmingSubmissions')];
    },
    action: function() {
        if (this.ready())
            this.render();
